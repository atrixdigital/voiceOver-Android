        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.getText().toString().equals("") || user.getText().toString().equals("") || pass.getText().toString().equals("") || conpass.getText().toString().equals("")) {
                    ...
                    ref.child("Voice_Users").child("Registered_Users").child(name.getText().toString()).setValue(new User( user.getText().toString(),name.getText().toString(), pass.getText().toString()));
